 ...
 */
public class six extends GLJPanel implements GLEventListener  {
...
gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT, materials[7], 0);
gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_DIFFUSE, materials[2], 4 );
gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, materials[2], 3 );
...
for (int i = 0; i <= n; i ++)
{
    ...
    // reverse normal to face the other way
    U = new float[]{x-x0,y-y,z-z0};
    V = new float[]{0, h, 0-x0};
    gl2.glNormal3f(U[1]*V[2]-U[2]*V[1],U[2]*V[0]-U[0]*V[2],U[0]*V[1]-U[1]*V[0]);
    gl2.glVertex3f(x, y, z);
    gl2.glVertex3f(x0, y, z0);
    gl2.glVertex3f(0, h, 0);
...
gl2.glEnd();
	...
	public void init(GLAutoDrawable drawable) {
		...
		float[] swiatlo1  = {0.5f, 0.5f, 0.5f, 1};
		float[] swiatlo2  = {0, 0, 0.4f, 1};
		float[] swiatlo3  = {0.4f, 0.3f, 0.3f, 1};
		gl2.glLightfv (gl2.GL_LIGHT1, gl2.GL_DIFFUSE, swiatlo1,1);
		gl2.glLightfv (gl2.GL_LIGHT1, gl2.GL_SPECULAR, swiatlo2,0);
		gl2.glLightfv (gl2.GL_LIGHT1, gl2.GL_AMBIENT, swiatlo3,0);
	...
	private class MouseHandler extends MouseAdapter {
		...
		public void mousePressed(MouseEvent evt) {
			...
			prevX = evt.getX();
			dragging = true;
			six.this.addMouseMotionListener(this);
		}
		public void mouseReleased(MouseEvent evt) {
			dragging = false;
			six.this.removeMouseMotionListener(this);
		}
