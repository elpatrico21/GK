...
float green = 0.0f;
float deltaGreen = 0.2f;
gl2.glBegin(GL_POINTS);
for (int i = 0; i < 130; i++) {
float radius = 2.0f;
float x = radius * (float)Math.cos(i * 2 * Math.PI / 20);
float y = radius * (float)Math.sin(i * 2 * Math.PI / 20);
float z = 0.05f * i;
gl2.glColor3f(0.0f, green, 0.0f);
gl2.glPointSize(2.0f + i / 5.0f);
